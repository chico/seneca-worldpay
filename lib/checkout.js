...
module.exports = function(options) {
  ...
  function payHandler(req, res, next) {
    ...
    seneca.act({role:'transaction', cmd:'create', data:transactionData}, function(err, out) {
      ...
      var completeCallbackUrl = urlappend(urljoin(hostUrl, endpoints.completeCallback), 'refno', transaction.refno);
      var cancelCallbackUrl = urlappend(urljoin(hostUrl, endpoints.cancelCallback), 'refno', transaction.refno);
